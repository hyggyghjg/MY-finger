...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.setWindowIcon(QIcon("master.png"))
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.btn1 = QtWidgets.QPushButton(self.centralwidget)
        self.btn1.setGeometry(QtCore.QRect(150, 10, 251, 71))
        self.btn1.setObjectName("btn1")
        self.te1 = QtWidgets.QTextEdit(self.centralwidget)
        self.te1.setEnabled(False)
        self.te1.setGeometry(QtCore.QRect(150, 100, 251, 401))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn1.setText(_translate("MainWindow", "拍摄图片"))
